    ...
    public class ChocolateyInteractiveCommand : ChocolateyCommandBase, ICommand
    {
        ...
        public virtual void ParseAdditionalArguments(IList<string> unparsedArguments, ChocolateyConfiguration configuration)
        {
            ...
            if (unparsedArguments.Count > 1)
                throw new ApplicationException("Multiply package names supplied, please supply only one package name.");
        ...
        public virtual void Validate(ChocolateyConfiguration configuration)
        {
            ...
            {
                throw new ApplicationException("Package name is required. Please supply exactly one package name to upgrade.");
            }
